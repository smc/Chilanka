...
test: ttf otf $(PDFS)
	...
	fontbakery check-googlefonts -x com.google.fonts/check/name/license -x com.google.fonts/check/version_bump -x com.google.fonts/check/vertical_metrics_regressions $(BLDDIR)/*.ttf
